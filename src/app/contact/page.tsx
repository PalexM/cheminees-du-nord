                        ...
                        <div className="flex flex-wrap -mx-4 ">
                            <div className="w-full md:w-1/2  px-4 mb-10">
                                <div className="max-w-xs mx-auto">
                                    <div className="inline-flex mb-6 items-center justify-center w-12 h-12 bg-blue-500 rounded-full">
        ...
        06 58 28 57 56
                            ...
                            <div className="w-full md:w-1/2 px-4 mb-10">
                                <div className="max-w-xs mx-auto">
                                    ...
                                    <h3 className="mb-9 text-2xl md:text-3xl font-bold leading-9 text-coolGray-900">Reseaux</h3>
